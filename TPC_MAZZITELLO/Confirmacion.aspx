<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Confirmacion.aspx.cs" Inherits="TPC_MAZZITELLO.Confirmacion" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="centrar titulo">
            <asp:Label ID="lblCli" runat="server"
                Text="¡¡¡ CREACION DE SOLICITUD EXITOSA !!!"></asp:Label>
        </div>

            <div class="centrar">
                <asp:Image ID="imgConf" runat="server"
                    ImageUrl="~/Images/confirmacion.jpg" />
            </div>

            <div class="centrar titulo">
                <asp:Label ID="lblAdm" runat="server"
                    Text="¡¡¡ CREACION DE PRESTAMO EXITOSA !!!" ></asp:Label>
            </div>
