<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccionExitosa.aspx.cs" Inherits="TPC_MAZZITELLO.AccionExitosa" %>
...
<body style=" background:#8bb59d">
    <form id="form1" runat="server">
        
        <div class="centrar">
                <asp:Image ID="imgConf" runat="server"
                    ImageUrl="~/Images/exitosa.jpg" Width="750px" Height="600px"/>
            </div>

            <div class="centrar titulo">
                <asp:Label ID="lblAdm" runat="server"
                    Text="¡¡¡ MODIFICACION EXITOSA !!!" ></asp:Label>
            </div>
